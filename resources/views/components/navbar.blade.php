<nav aria-label="secondary" x-data="{ open: false }"
    class="sticky top-0 z-10 flex items-center justify-between px-4 py-4 sm:px-6 transition-transform duration-500 bg-red-700 text-white dark:bg-dark-eval-1"
    :class="{
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="time" id="currentTime2"></div>

        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center p-2 text-sm bg-white shadow-md font-medium text-gray-500 rounded-md transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none focus:ring focus:ring-red-500 focus:ring-offset-1 focus:ring-offset-white dark:focus:ring-offset-dark-eval-1 dark:text-gray-400 dark:hover:text-gray-200">
...
<script>
    function updateTime() {
        ...
        document.getElementById('currentTime2').innerText = formattedTime;
    }
