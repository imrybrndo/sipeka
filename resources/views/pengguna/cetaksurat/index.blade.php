...
<body class="font-sans antialiased">
    <div class="print">
        ...
        <section>
            <div class="mt-32">
                <p class="text-center font-bold text-2xl">PERJANJIAN KINERJA TAHUN 2024 SEKRETARIS DAERAH KOTA MANADO
                </p>
            </div>
            <div class="mt-3">
...
<body>
    <div class="print">
        <section>
            ...
            <div class="container mx-auto">
                <div style="height: 5px; background-color: black; border: none;">
            </div>
        </section>
        <section>
            <div>
